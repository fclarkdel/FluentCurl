...
SPECIALIZE_CURL_OPT_PARAM(CURLOPT_COPYPOSTFIELDS, const char*);
SPECIALIZE_CURL_OPT_PARAM(CURLOPT_HTTPHEADER, curl_slist*);
SPECIALIZE_CURL_OPT_PARAM(CURLOPT_NOPROGRESS, long);
...
SPECIALIZE_CURL_OPT_PARAM(CURLOPT_XFERINFODATA, void*);
SPECIALIZE_CURL_OPT_PARAM(CURLOPT_XFERINFOFUNCTION, int(void*, curl_off_t, curl_off_t, curl_off_t, curl_off_t));
}
#endif